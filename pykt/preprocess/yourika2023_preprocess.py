...
KEYS = ["user_id", "topic_id", "question_id"]
...
def read_data_from_csv(read_file, write_file):
    ...
    df["order_id"] = df["answered_at"].argsort()
    ...
    _df = df.dropna(subset=["user_id","question_id", "topic_id", "correct", "order_id"])
    ...
    for ui in ui_df:
        ...
        seq_skills = tmp_inter['topic_id'].tolist()
